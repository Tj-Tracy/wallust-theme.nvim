...
M.highlights_base = function(colors)
	return {
		...
		-- MiniStatusLine
		MiniStatuslineModeCommand = { fg = colors.foreground, bg = colors.color5, bold = true },
		MiniStatuslineModeInsert = { fg = colors.foreground, bg = colors.color11, bold = true },
		MiniStatuslineModeNormal = { fg = colors.foreground, bg = colors.color2, bold = true },
